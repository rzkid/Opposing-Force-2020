...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.HighlightFgColor		"BrightYellow"
		...
		Frame.BgColor					"GoldSrcGreen"	[$WIN32]
		Frame.OutOfFocusBgColor			"GoldSrcGreen"	[$WIN32]
		...
		Menu.BgColor					"DullGoldSrcGreen"
		Menu.ArmedTextColor				"White"
		Menu.ArmedBgColor				"Yellow"
		Menu.TextInset					"6"

		Panel.FgColor					"DullWhite"
		Panel.BgColor					"Blank"

		ProgressBar.FgColor				"BrightYellow"
