...
ConVar dev_mega_physcannon_active("dev_mega_physcannon_active", "0");
...
{
	//return ( OF2GameRules()->MegaPhyscannonActive() == true );
	//DevWarning("bool PlayerHasMegaPhysCannon()\n");
	return dev_mega_physcannon_active.GetBool();
}
